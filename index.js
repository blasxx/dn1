...
const embed = new EmbedBuilder()
.setTitle("Unid - Kullanıcı Paneli!")
...
.setCustomId('form13')
.setTitle('Unid - Menülü Rol Alma Sistemi!')
...
value: "s2"
    ...
    const embed = new EmbedBuilder()
    .setTitle("Unid - Rol Alma Sistemi!")
...
client.on("interactionCreate", async (interaction, message) => {
  ...
  if(interaction.customId === "yardım") {
    ...
    let message = interaction.message.id
      ...
      .setTitle("Unid - Moderasyon Sistemi!")
    ...
    if (interaction.values[0] == "kullanıcı") { 
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Unid - Kullanıcı Sistemi!")
